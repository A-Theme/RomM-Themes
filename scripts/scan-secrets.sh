#!/usr/bin/env bash
# Pre-commit / pre-release secret scanner for RomM-Themes.
#
...
#
# This repo is theme folders, screenshots and a generated manifest - it holds
# no console keys and no app credentials of its own. The realistic risk is
# smaller and generic: a stray personal token or key pasted into a script,
# workflow file, or README while adding tooling later.
